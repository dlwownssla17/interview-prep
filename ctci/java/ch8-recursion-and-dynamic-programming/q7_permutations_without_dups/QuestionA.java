...
public class QuestionA {
    ...
    public static ArrayList<String> permutationsWithoutDups(String s) {
        ...
        permutationsWithoutDupsHelper(s, new LinkedList<>(), permutations);
        return permutations;
    }

    private static void permutationsWithoutDupsHelper(String rem, LinkedList<Character> buf, ArrayList<String> permutations) {
        if (rem.isEmpty()) {
