...
public class Tester {
    ...
    public void testSumListsForwardOrder() throws Exception {
        ...
        Node<Integer> sum1 = sumListsForwardOrder(a1, b1);
        ...
        Node<Integer> d2 = new Node(0);
        Node<Integer> d3 = new Node(0);
        Node<Integer> d4 = new Node(0);
        d1.next = d2;
        d2.next = d3;
        d3.next = d4;

        Node<Integer> sum2 = sumListsForwardOrder(c1, d1);
        ...
        Node<Integer> sum3 = sumListsForwardOrder(e1, f1);
        ...
        Node<Integer> h3 = new Node(0);
        Node<Integer> h4 = new Node(0);
        g1.next = g2;
        h1.next = h2;
        h2.next = h3;
        h3.next = h4;

        Node<Integer> sum4 = sumListsForwardOrder(g1, h1);

        int[] arr4 = new int[4];
        int[] testArr4 = new int[] {1, 0, 1, 1};
        int incr4 = 0;
        Node<Integer> testNode4 = sum4;
        while (testNode4 != null) {
            arr4[incr4] = testNode4.data;
            incr4++;
            testNode4 = testNode4.next;
        }
